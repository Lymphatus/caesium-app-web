...
export default function CompressionControls() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1 rounded-xl border p-4 shadow-sm">
          ...
          >
            ...
            <TabsContent className="space-y-4 pt-4" value="quality">
              <div className="space-y-4">
                ...
                <Slider className="w-full" max={100} min={0} step={1} value={[quality]} onValueChange={(value) => setQuality(value[0])} />
