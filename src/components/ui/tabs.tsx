...
function Tabs({ className, orientation = 'horizontal', ...props }: React.ComponentProps<typeof TabsPrimitive.Root>) {
  return <TabsPrimitive.Root className={cn('group/tabs flex gap-2 data-[orientation=horizontal]:flex-col', className)} data-orientation={orientation} data-slot="tabs" orientation={orientation} {...props} />;
}
  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        ...
        'data-[state=active]:bg-background dark:data-[state=active]:text-primary dark:data-[state=active]:border-input dark:data-[state=active]:bg-primary/20 data-[state=active]:text-foreground',
