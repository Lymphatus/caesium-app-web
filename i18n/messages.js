const messages = {
    'en-US': {
        compressor: {
            ...
            max_files: 'Max 5 files at time',
            max_file_size: 'Max 20 Mb per single file',
    ...
    'es-ES': {
        compressor: {
            ...
            max_files: 'Máximo 5 archivos al mismo tiempo',
            max_file_size: 'Máximo 20 Mb por cada archivo',
    ...
    'it-IT': {
        compressor: {
            ...
            max_files: 'Massimo 5 files alla volta',
            max_file_size: 'Massimo 20 Mb per singolo file',
    ...
    'pl-PL': {
        compressor: {
            ...
            lossless_help:
                'Z tą opcją wybraną, jakość zdjęcia zostanie w pełni zachowana.<br/>Pliki PNG zawsze są przetwarzane bezstratnie, a włączenie tej opcji może spowodować zwiększenie rozmiaru pliku.',
    ...
    'zh-CN': {
        compressor: {
            ...
            max_files: '一次最多 5 个文件',
            max_file_size: '每个文件最大 20 Mb',
