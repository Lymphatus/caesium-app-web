...
<template>
  <div
      class="h-full container max-w-[1200px] mx-auto flex flex-col gap-6 py-8 dark:text-gray-100 text-gray-800 px-2 sm:px-4 justify-between">
    <p><strong>PRIVACY POLICY</strong></p>
    <p><strong>Last updated March 03, 2023</strong></p>
    <p>This privacy notice for SaeraSoft ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"),
      describes how and why we might collect, store, use, and/or share ("<strong>process</strong>") your information
      when you use our services ("<strong>Services</strong>"), such as when you:</p>
    <ul>
      <li>Visit our website at <a href="https://saerasoft.com">https://saerasoft.com</a>, or any website of ours that
    ...
    <p><strong>Questions or concerns? </strong>Reading this privacy notice will help you understand your privacy rights
      ...
      have any questions or concerns, please contact us at info@saerasoft.com.</p>
    <p><strong>SUMMARY OF KEY POINTS</strong></p>
    <p><strong>This summary provides key points from our privacy notice, but you can find out more details about any of
      these topics by clicking the link following each key point or by using our table of contents below to find the
      section you are looking for. You can also click </strong><a href="#toc"><strong>here</strong></a><strong> to go
      directly to our table of contents.</strong></p>
    <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may
      process personal information depending on how you interact with SaeraSoft and the Services, the choices you make,
      and the products and features you use. Click <a href="#personalinfo">here</a> to learn more.</p>
    ...
    <p><strong>How do we process your information?</strong> We process your information to provide, improve, and
      ...
      also process your information for other purposes with your consent. We process your information only when we have
      a valid legal reason to do so. Click <a href="#infouse">here</a> to learn more.</p>
    <p><strong>In what situations and with which types of parties do we share personal information?</strong> We may
      share information in specific situations and with specific categories of third parties. Click <a href="#whoshare">here</a>
      to learn more.</p>
    <p><strong>How do we keep your information safe?</strong> We have organizational and technical processes and
      ...
      improperly collect, access, steal, or modify your information. Click <a href="#infosafe">here</a> to learn more.
    </p>
    <p><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy
      law may mean you have certain rights regarding your personal information. Click <a href="#privacyrights">here</a>
      to learn more.</p>
    <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by filling out our
      data subject request form available <a href="https://app.termly.io/notify/4d8bfa18-8381-40d6-acdc-568ced297ac5">here</a>,
      or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
    </p>
    <p>Want to learn more about what SaeraSoft does with any information we collect? Click <a href="#toc">here</a> to
    ...
    <p><a href="#virginia">14. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></p>
    <p><a href="#policyupdates">15. DO WE MAKE UPDATES TO THIS NOTICE?</a></p>
    <p><a href="#contact">16. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></p>
    <p><a href="#request">17. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></p>
    ...
    <p><strong>In Short:</strong><strong/>Some information - such as your Internet Protocol (IP) address and/or
    ...
    <p>Like many businesses, we also collect information through cookies and similar technologies. You can find out more
      about this in our Cookie Notice: <a
          href="https://saerasoft.com/cookiePolicy">https://saerasoft.com/cookiePolicy</a>.</p>
    <p>The information we collect includes:</p>
    <ul>
      <li>Log and Usage Data. Log and usage data is service-related, diagnostic, usage, and performance information our
        servers automatically collect when you access or use our Services and which we record in log files. Depending on
    ...
    <ul>
      <li>Device Data. We collect device data such as information about your computer, phone, tablet, or other device
    ...
    <ul>
      <li>Location Data. We collect location data such as information about your device's location, which can be either
    ...
    <ul>
      <li>
        ...
        personalized content and advertising tailored to your interests, location, and more. For more information see
        our Cookie Notice: <a href="https://saerasoft.com/cookiePolicy">https://saerasoft.com/cookiePolicy</a>.
      </li>
    </ul>
    <ul>
    ...
    <ul>
      <li>
        ...
        your personal information for a specific purpose. You can withdraw your consent at any time. Click <a
          href="#withdrawconsent">here</a> to learn more.
      </li>
    </ul>
    <ul>
      <li><strong>Legitimate Interests.</strong> We may process your information when we believe it is reasonably
        ...
        fundamental rights and freedoms. For example, we may process your personal information for some of the purposes
    ...
    <p>We may process your information if you have given us specific permission (i.e., express consent) to use your
      ...
      consent). You can withdraw your consent at any time. Click <a href="#withdrawconsent">here</a> to learn more.</p>
    ...
    <p><strong>In Short:</strong> We may share information in specific situations described in this section and/or with
      the following categories of third parties.</p>
    <p><strong>Vendors, Consultants, and Other Third-Party Service Providers.</strong> We may share your data with
      third-party vendors, service providers, contractors, or agents ("<strong>third parties</strong>") who perform
      services for us or on our behalf and require access to such information to do that work. We have contracts in
      place with our third parties, which are designed to help safeguard your personal information. This means that they
      cannot do anything with your personal information unless we have instructed them to do it. They will also not
    ...
    <p><strong>5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</strong></p>
    ...
    <p><strong>6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</strong></p>
    ...
    <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store
      information. Specific information about how we use such technologies and how you can refuse certain cookies is set
      out in our Cookie Notice: <a href="https://saerasoft.com/cookiePolicy">https://saerasoft.com/cookiePolicy</a>.</p>
    <p><strong>7. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</strong></p>
    <p><strong>In Short: </strong>We may transfer, store, and process your information in countries other than your own.
    </p>
    <p>Our servers are located in the United States. If you are accessing our Services from outside the United States,
      please be aware that your information may be transferred to, stored, and processed by us in our facilities and by
      those third parties with whom we may share your personal information (see "<a href="#whoshare">WHEN AND WITH WHOM
        DO WE SHARE YOUR PERSONAL INFORMATION?</a>" above), in the United States, and other countries.</p>
    <p>If you are a resident in the European Economic Area (EEA) or United Kingdom (UK), then these countries may not
    ...
    <p>We have implemented measures to protect your personal information, including by using the European Commission's
      ...
      our third-party service providers and partners and further details can be provided upon request.</p>
    ...
    <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you
      ...
      at info@saerasoft.com.</p>
    <p><strong>11. WHAT ARE YOUR PRIVACY RIGHTS?</strong></p>
    <p><strong>In Short:</strong> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and
    ...
    <p>In some regions (like the EEA, UK, and Canada), you have certain rights under applicable data protection laws.
      ...
      section "<a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>" below.</p>
    ...
    <p>If you are located in the EEA or UK and you believe we are unlawfully processing your personal information, you
      ...
      details here: <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm">https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</a>.
    </p>
    ...
    <p><strong>Withdrawing your consent:</strong> If we are relying on your consent to process your personal
      ...
      details provided in the section "<a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>" below.</p>
    ...
    <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you
      ...
      For further information, please see our Cookie Notice: <a href="https://saerasoft.com/cookiePolicy">https://saerasoft.com/cookiePolicy</a>.
    </p>
    ...
    <p><strong>In Short: </strong>Yes, if you are a resident of California, you are granted specific rights regarding
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          <p>Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique
            personal identifier, online identifier, Internet Protocol address, email address, and account name</p>
        </td>
        <td>
          <p>YES</p>
        </td>
      ...
      <tr>
        ...
        <td>
          <p>Browsing history, search history, online behavior, interest data, and interactions with our and other
            websites, applications, systems, and advertisements</p>
        </td>
        <td>
          <p>YES</p>
        </td>
      ...
      <tr>
        ...
        <td>
          <p>Business contact details in order to provide you our Services at a business level or job title, work
            history, and professional qualifications if you apply for a job with us</p>
        </td>
        <td>
          <p>NO</p>
        </td>
      ...
      <tr>
        ...
        <td>
          <p>Inferences drawn from any of the collected personal information listed above to create a profile or summary
            about, for example, an individual's preferences and characteristics</p>
        </td>
        <td>
          <p>NO</p>
        </td>
    ...
    <p>More information about our data collection and sharing practices can be found in this privacy notice and our
      Cookie Notice: <a href="https://saerasoft.com/cookiePolicy">https://saerasoft.com/cookiePolicy</a>.</p>
    <p>You may contact us by email at info@saerasoft.com, or by referring to the contact details at the bottom of this
      document.</p>
    ...
    <p>We may disclose your personal information with our service providers pursuant to a written contract between us
      ...
      behalf, following the same strict privacy protection obligations mandated by the CCPA.</p>
    <p>We may use your personal information for our own business purposes, such as for undertaking internal research for
      ...
      information.</p>
    <p>SaeraSoft has not sold or shared any personal information to third parties for a business or commercial purpose
      in the preceding twelve (12) months. SaeraSoft has disclosed the following categories of personal information to
      third parties for a business or commercial purpose in the preceding twelve (12) months:</p>
    <p>The categories of third parties to whom we disclosed personal information for a business or commercial purpose
      can be found under "<a href="#whoshare">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>".</p>
    ...
    <p>You can ask for the deletion of your personal information. If you ask us to delete your personal information, we
    ...
    <ul>
      <li>the categories of third parties to whom the personal information was sold, shared, or disclosed for a business
        purpose;
      </li>
    </ul>
    <ul>
    ...
    <ul>
      <li>You may request to opt out from future selling or sharing of your personal information to third parties. Upon
        receiving an opt-out request, we will act upon the request as soon as feasibly possible, but no later than
        fifteen (15) days from the date of the request submission.
      </li>
    </ul>
    <p>To exercise these rights, you can contact us by email at info@saerasoft.com, or by referring to the contact
      details at the bottom of this document. If you have a complaint about how we handle your data, we would like to
      hear from you.</p>
    <p><strong>14. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></p>
    <p><strong>In Short:</strong> Yes, if you are a resident of Virginia, you may be granted specific rights regarding
      access to and use of your personal information.</p>
    ...
    <p>If this definition "consumer" applies to you, we must adhere to certain rights and obligations regarding your
      personal data.</p>
    <p>The information we collect, use, and disclose about you will vary depending on how you interact with SaeraSoft
      and our Services. To find out more, please visit the following links:</p>
    <ul>
      <li>
    ...
    <p>SaeraSoft has not sold any personal data to third parties for business or commercial purposes. SaeraSoft will not
      sell personal data in the future belonging to website visitors, users, and other consumers.</p>
    <p>Exercise your rights provided under the Virginia CDPA</p>
    <p>More information about our data collection and sharing practices can be found in this privacy notice and our
      Cookie Notice: <a href="https://saerasoft.com/cookiePolicy">https://saerasoft.com/cookiePolicy</a>.</p>
    <p>You may contact us by email at info@saerasoft.com, by visiting our <a
        href="https://app.termly.io/notify/4d8bfa18-8381-40d6-acdc-568ced297ac5">data subject request form</a>, or by
    ...
    <p>Upon receiving your request, we will respond without undue delay, but in all cases, within forty-five (45) days
      of receipt. The response period may be extended once by forty-five (45) additional days when reasonably necessary.
      We will inform you of any such extension within the initial 45-day response period, together with the reason for
      the extension.</p>
    <p>Right to appeal</p>
    <p>If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it.
      If you wish to appeal our decision, please email us at info@saerasoft.com. Within sixty (60) days of receipt of an
      ...
      General to <a href="https://www.oag.state.va.us/consumer-protection/index.php/file-a-complaint">submit a
        complaint</a>.</p>
    ...
    <p>__________</p>
    <p>__________</p>
    <p><strong>17. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</strong></p>
    <p>Based on the applicable laws of your country, you may have the right to request access to the personal
      ...
      your personal information, please fill out and submit a <a
          href="https://app.termly.io/notify/4d8bfa18-8381-40d6-acdc-568ced297ac5">data subject access request</a>.</p>
    <p>This privacy policy was created using Termly's <a href="https://termly.io/products/privacy-policy-generator/">Privacy
